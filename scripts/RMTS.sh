...
do
	# m = 0
	python3 ./train_and_eval.py --model_name $model_name --norm_type tasksegmented_contextnorm --lr 5e-4 --task RMTS --m_holdout 0 --epochs 50 --run $r --device $device --train_gen_method subsample --test_gen_method subsample
	# m = 50
