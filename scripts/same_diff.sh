...
do
	...
	# m = 50
	python3 ./train_and_eval.py --model_name $model_name --norm_type contextnorm --lr 5e-4 --task same_diff --m_holdout 50 --epochs 50 --run $r --device $device
	# m = 85
	...
	# m = 98
	python3 ./train_and_eval.py --model_name $model_name --norm_type contextnorm --lr 5e-4 --task same_diff --m_holdout 98 --epochs 100 --run $r --device $device
done